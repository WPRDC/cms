...
export interface ApiArtifactArtifact extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    relatedPages: Schema.Attribute.Component<'elements.link', true>;
    category: Schema.Attribute.Enumeration<['presentation', 'report']>;
...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    category: Schema.Attribute.Enumeration<
      ['talk', 'workshop', 'free-lunch', 'dog-petting-exhibition']
    >;
    links: Schema.Attribute.Component<'elements.link', true>;
    location: Schema.Attribute.Component<'elements.link', false>;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  attributes: {
    navbarLogo: Schema.Attribute.Component<'elements.logo', false> &
      Schema.Attribute.Required;
    navbarLinks: Schema.Attribute.Component<'elements.link', true>;
    footerLogo: Schema.Attribute.Component<'elements.logo', false>;
    affiliateLogos: Schema.Attribute.Component<'elements.logo', true>;
...
export interface ApiHomeHome extends Struct.SingleTypeSchema {
  ...
  attributes: {
    searchSection: Schema.Attribute.Component<
      ...
      false
    >;
    blurbs: Schema.Attribute.Component<'home-page.tiles', false>;
    publishers: Schema.Attribute.Component<'home-page.collaborators', false>;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiNavMenuItemNavMenuItem extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    primaryLink: Schema.Attribute.Component<'elements.link', false>;
    subMenu: Schema.Attribute.Component<'navbar.sub-menu-item', true>;
    defaultDescription: Schema.Attribute.RichText &
      Schema.Attribute.CustomField<
        'plugin::ckeditor.CKEditor',
        {
          output: 'HTML';
...
export interface ApiWeeknoteWeeknote extends Struct.CollectionTypeSchema {
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::weeknote.weeknote': ApiWeeknoteWeeknote;
